...
// ====== CONFIGURATION ====== 
const FROM_DATE = "01.05.2025"; // Start date - where to begin analysis (older date)
const TO_DATE = "01.08.2025"; // End date - where to finish analysis (newer date), set to undefined for "now"
