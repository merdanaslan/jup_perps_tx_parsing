...
// ====== CONFIGURATION ====== 
const FROM_DATE = "11.04.2025"; // Start date - where to begin analysis (older date)
const TO_DATE = "11.07.2025"; // End date - where to finish analysis (newer date), set to undefined for "now"
